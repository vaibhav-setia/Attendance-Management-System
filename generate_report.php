...
<body>
  ...
  <div class="navbar-header">
        <a class="navbar-brand" rel="home" href="./index.php">Attendance System</a>
    </div>
...
<div class="search_categories">
  <div class="col-sm-8">
    <div class="row">
      <div class="col-xs-12">
		<hr >
		<form name="insert" action="report.php" method="post">
  <table width="100%" height="117"  border="0">
  <tr>
  <input type="hidden" name="teacher" value="<?php echo $_GET['_id'];?>">
    <th width="27%" height="63" scope="row">Course: </th>
    <td width="73%"><select onChange="getclass(this.value);"  name="Course_ID" id="Course_ID" class="form-control" >
